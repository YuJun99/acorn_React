...
function App2(props) {
    ...
    //체크 박스의 체크여부 (버튼을 크게 만들지 여부) 를 상태값으로 관리
    ...
    return (
        <div className='container'>
            ...
            <button className={`btn btn-info ${isLarge? 'btn-lg':''}`}>버튼2</button>
            <button className={cn("btn", "btn-info", {"btn-lg":isLarge})}>버튼3</button>
            <button className={cx({default:!isLarge, large:isLarge})}>버튼4</button>
